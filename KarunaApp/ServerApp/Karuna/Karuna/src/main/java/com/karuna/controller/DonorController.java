...
public class DonorController {
    ...
    public ResponseEntity<?> updateDonor(@RequestBody RegisterDonorDto donor,@PathVariable Long donorId) {
    	return ResponseEntity.ok(donorService.updateDonor(donor,donorId));
    }
